...
# top-level per-stage summary, and emits a run_log.txt describing what
...
#' output triples plus a top-level per-stage summary and a `run_log.txt`
...
#'   pile up. That subfolder gets the per-stage CSV triples, the per-stage
#'   summary, and `run_log.txt`. The results list is also returned.
